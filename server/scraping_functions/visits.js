...
const scrapeVisits = async (startDate, numOfDays, socket) => {
	...
	for (let i = 0; i < numOfDays; i++) {
		...
		const skip = await page.evaluate(() => {
			...
			if (
				el?.innerText.includes("Přátelský zápas") &&
